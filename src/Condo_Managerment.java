...
public class Condo_Managerment {
                ...
                if(!(floor>0)){
                    ...
                    con=sc.next();
                            ...
                            if(!(room>0)){
                                ...
                                String manuList="";
                                System.out.println("=======================");
                                System.out.println("You have successfull set up the condo");
                                ...
                                do{
                                    System.out.println("||||======Wellcome To Condo Management System=====||||");
                                    ...
                                    switch (op){
                                        ...
                                        case 2:
                                            ...
                                            if(!(arr[sellRow-1][sellCol-1]==arr[a][b])) {
                                                System.out.println("Selected Condo Information.");
                                                System.out.println("Floor :"+sellRow+" Room :"+sellCol+" Belong To :"+arr[sellRow-1][sellCol-1]);

                                                System.out.println("Enter 1 to confirm and 0 to concel.");
                                                int confirmSell = sc.nextInt();
                                                if(confirmSell==1){
                                                    System.out.println("Congratulation ! You have successful sell your condo.");
                                                    arr[sellRow-1][sellCol-1]=null;
                                                }else {
                                            ...
                                            switch (manu) {
                                                case 1: {
                                                    ...
                                                    for (int i=0;i<floor;i++){
                                                        for (int j=0;j<room;j++){
                                                          if(s_value.equals(arr[i][j])){
                                                              nameSelect=true;
                                                              System.out.println("Owner Name :"+arr[i][j]+" stay in room :"+(i+1)+" Floor No :" +(j+1));
                                                          }
                                                        }
                                                    }
                                                    if(nameSelect==false){
                                                ...
                                                case 2: {
                                                    ...
                                                    for (int j=0;j<floor;j++) {
                                                        System.out.print(arr[s_floor-1][j] + " ");
                                                    }
                                                        System.out.println();
                                                    }else{
